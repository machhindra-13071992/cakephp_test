...
<?php echo $this->Form->create('SystemDetail'); ?>
	...
	<?php
		...
		echo $this->Form->input('status', array('type'=>'select', 'options'=>array('W' => 'Working', 'U' => 'Used', 'NW' => 'Non-Working'), 'label'=>'System Status', 'style'=>'width:205px'));
                echo $this->Form->input('comment', array('type'=>'textarea', 'style'=>'width:200px; height:80px;', 'label' => 'Comments'));
...
<script>
    ...
    $(function() {
    $("#SystemDetailWarranty").datepicker({dateFormat:'dd-mm-yy', maxDate:0,
            onSelect: function(dateText, inst){
            console.log(dateText);
            }});
//            $( "#SystemDetailInDate" ).datepicker({dateFormat:'dd-mm-yy', maxDate:0,
//                onSelect: function(dateText, inst){
//                        console.log(dateText);
//            }});
       });
