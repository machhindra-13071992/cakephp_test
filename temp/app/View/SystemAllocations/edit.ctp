...
<?php echo $this->Form->create('SystemAllocation'); ?>
	<fieldset>
		<legend><?php echo __('Edit System Allocation'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SystemAllocation.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('SystemAllocation.id'))); ?></li>
