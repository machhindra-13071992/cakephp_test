<div class="locations index">
	...
	<?php foreach ($locations as $location): ?>
        <tr>
            ...
            <td><a style="text-decoration:none" href="SystemDetails/filter/location:<?php echo $location['Location']['id']; ?>"><?php echo h($systemByLocations[$location['Location']['id']]); ?></a>&nbsp;</td>
            <td class="actions">
